var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: 'Many Strata Malls are located in downtown Singapore, concentraded around the commercial district of the city. <br><img src="images/land use.png" style="height:100%;width:150px;"></img>',
            location: {
